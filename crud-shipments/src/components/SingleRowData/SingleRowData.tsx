    ...
    return (
        ...
        <tr className="shipments-single-data">
            ...
            <td className="shipments-actions">
                <button className="btn btn-blue" onClick={handlePopUpOpen}>
                ...
                <button className="btn btn-red" onClick={onShipmentDelete}>
                    <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Menu / Close_SM">
        ...
        { isOpen &&
            <PopUpUpdate onPopUpClose={handlePopUpClose} shipment={shipment}/>
        }
        </>
    )
}